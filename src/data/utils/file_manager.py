...
class CTGFileManager:
    ...
    def __init__(
        self, base_dir="/Users/diyagamah/Documents/nba_props_model/data/ctg_data_organized"
    ):  # noqa: E501
        ...
        self.stat_mappings = {
            ...
            "on_off_opponent_halfcourt_putbacks": "on_off/opponent_halfcourt_putbacks",  # noqa: E501
            "on_off_opponent_shooting_accuracy": "on_off/opponent_shooting_accuracy",  # noqa: E501
            "on_off_opponent_shooting_frequency": "on_off/opponent_shooting_frequency",  # noqa: E501
    ...
    def get_file_path(self, stat_type, season, season_type="regular_season", entity_type="players"):
        ...
        if stat_type not in self.stat_mappings:
            raise ValueError(
                f"Unknown stat type: {stat_type}. Available types: {
                    list(
                        self.stat_mappings.keys())}"
            )
    ...
    def load_dataframe(
        self, stat_type, season, season_type="regular_season", entity_type="players"
    ):
        """
    ...
    def list_available_data(self, entity_type="players", season=None, season_type=None):
        ...
        for csv_file in base_path.rglob("*.csv"):
            ...
            if len(path_parts) == 3:
                # Direct file: players/2024 -
                # 25/regular_season/defense_rebounding.csv
                stat_category = csv_file.stem
            else:
                # Nested file: players/2024 -
                # 25/regular_season/on_off/efficiency_four_factors.csv
            ...
            files.append(
                {
                    ...
                    "modified_time": datetime.fromtimestamp(csv_file.stat().st_mtime),  # noqa: E501
                }
            )
                ...
                by_season[season][file_info["season_type"]].append(
                    {
                        ...
                        "modified": file_info["modified_time"].strftime(
                            "%Y-%m-%d %H:%M"
                        ),  # noqa: E501
                    }
                )
