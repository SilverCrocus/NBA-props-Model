...
- models/production_2024_25_meta.pkl

Usage: uv run python scripts/production/train_production_model_2024_25.py
"""
...
train_cutoff = pd.Timestamp(TEST_START)
train_data = historical_df[historical_df["GAME_DATE"] < train_cutoff].copy()
test_data = historical_df[historical_df["GAME_DATE"] >= train_cutoff].copy()
...
# ======================================================================
# 3. BUILD FEATURES (ONCE FOR ALL DATA)
# ======================================================================
...
# ======================================================================
# 4. TIME-SERIES CROSS-VALIDATION TRAINING
# ======================================================================
...
# Save importance
importance_df.to_csv("data/results/production_2024_25_feature_importance.csv", index=False)
print("   ✅ Saved to data/results/production_2024_25_feature_importance.csv")
print()
