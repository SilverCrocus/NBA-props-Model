...
VALIDATION_DATA_PATH = (
    # 2023 - 24 season backtest (has predictions)
    "data/results/backtest_walkforward_2023_24.csv"
)
...
print(
    f"   Calibration set: {
        len(val_calib):,    } samples (2023 - 24 early season)"
)
...
# Calculate metrics
print("   Before calibration (2023 - 24 validation test):")
...
print("   After calibration (2023 - 24 validation test):")
...
model_dict["calibration_trained_on"] = "2023 - 24 validation data (out-of-sample)"  # noqa: E501
...
------------------------------------------------------
- MAE before calibration: {mean_absolute_error(y_actual_test, y_pred_test):.2f} pts  # noqa: E501
...
--------------------
✅ Calibrator trained on different time period than test set (2023 - 24 vs 2024 - 25)  # noqa: E501
...
print("📊 Key Results:")
print(
    f"   MAE improvement on 2023 - 24: {
        mean_absolute_error(
            y_actual_test,
            y_pred_test):.2f} → {
                mae_after:.2f} pts"
)
print("   Trained on: 2023 - 24 validation data (OUT-OF-SAMPLE)")
print("   Ready to apply to: 2024 - 25 test data (TRULY OUT-OF-SAMPLE)")
print()
print("🔍 Critical Difference from Previous Version:")
print("   ❌ Old: Calibrator trained on 80% of 2024 - 25 test data (LEAKAGE)")
print("   ✅ New: Calibrator trained on 2023 - 24 validation data (NO LEAKAGE)")
print()
print("📈 Expected Performance on 2024 - 25:")
print("   Win rate: 54 - 58% (realistic)")
print("   ROI: +3 - 8% (achievable)")
print("   p-value: > 0.05 (statistically plausible)")
print()
print(
    "🎯 Next Step: Apply calibration to 2024 - 25 test data and recalculate performance"
)  # noqa: E501
print("=" * 80)
