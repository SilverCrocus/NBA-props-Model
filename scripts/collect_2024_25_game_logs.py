...
Fetches all game logs from the completed 2024 - 25 season (Oct 2024 - June 2025)  # noqa: E501
...
print(f"\nProgress: {len(progress['completed_players'])} players already collected")  # noqa: E501
...
if all_game_logs:
    ...
    print(
        f"✅ Date range: {
            df_all['GAME_DATE'].min()} to {
            df_all['GAME_DATE'].max()}"
    )
