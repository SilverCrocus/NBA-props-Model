"""
CORRECTED 2023-24 Backtest - Properly Deduplicated

Fixes the duplicate prediction issue and calculates true ROI.
"""
...
print("="*80)
print("NBA PROPS MODEL - 2023-24 BACKTEST (CORRECTED)")
print("="*80)

# Load predictions and odds
print("\n1. Loading data...")
preds_df = pd.read_csv('data/results/baseline_predictions_2023-24.csv')
...
print("\n" + "="*80)
print("CORRECTED 2023-24 BACKTEST RESULTS")
print("="*80)
...
# Save results
output_file = "data/results/backtest_2023_24_corrected.csv"
...
with open("data/results/backtest_2023_24_corrected_summary.json", 'w') as f:
...
print(f"""
✅ CORRECTED 2023-24 BACKTEST COMPLETE
...
Result: {'✅ STILL VERY PROFITABLE!' if total_profit > 0 else '❌ Not profitable'}
...
Status: {'✅ CRUSHING ELITE BENCHMARKS' if total_profit/total_wagered*100 > 12 else '✅ Exceeding good benchmarks'}
""")
