...
def rebuild_progress():
    ...
    for csv_file in csv_files:
        ...
        if len(parts) >= 4 and parts[0] == "players":
            ...
            # e.g., "regular_season" or "playoffs"
            season_type_folder = parts[2]
            ...
            if parts[3] == "on_of" and len(parts) >= 5:
                # On/Off subcategory
                subcategory = parts[4]
                # Map back to original category name
                category_map = {
                    "efficiency_four_factors": "On/Off Efficiency & Four Factors",  # noqa: E501
                    "team_shooting_frequency": "On/Off Team Shooting: Frequency",  # noqa: E501
                    "team_shooting_accuracy": "On/Off Team Shooting: Accuracy",
                    "team_halfcourt_putbacks": "On/Off Team Halfcourt & Putbacks",  # noqa: E501
                    "team_transition": "On/Off Team Transition",
                    "opponent_shooting_frequency": "On/Off Opponent Shooting: Frequency",  # noqa: E501
                    "opponent_shooting_accuracy": "On/Off Opponent Shooting: Accuracy",  # noqa: E501
                    "opponent_halfcourt_putbacks": "On/Off Opponent Halfcourt & Putbacks",  # noqa: E501
    ...
    progress_data = {
        ...
        "completion_rate": f"{
            len(completed) * 100 / len(all_combinations):.1f}%",
    }
    ...
    print("✅ Now run: python3 ctg_robust_scraper.py")
